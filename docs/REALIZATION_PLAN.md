...
| L5 · Release, deployment & self-update | M8, M10 (AR19) | **built**, awaiting report sign-off — everything except the rollout itself, which Kenny holds behind a go per action (D9) |
