...
| L4b · Dashboard & token management | M12 (AR17 amendment) | **done**, report approved 2026-08-28 — CI https://github.com/kennypassenier/almanac/actions/runs/33192274769 |
| L5 · Release, deployment & self-update | M8, M10 (AR19) | **done**, report approved 2026-08-28 — everything but the rollout itself, which Kenny holds behind a go per action (D9); the LXC reboot drill in the exit criteria moves with it |
